...
function tickKeyPresses(deltaScale) {
    ...
    if (gameVars.cameraMoveVel != 0) {
        ...
        if (gameState.isInShed) {
            ...
            } else if (gameVars.cameraPosX > 2650 && !gameVars.warningTwo) {
            ...
            } else if (gameVars.cameraPosX > 3600 && !gameVars.warningThree) {
                gameVars.cameraMoveAcc = 0;
                gameVars.cameraMoveVel = 0;
            ...
            } else if (gameVars.cameraPosX > 4100 && !gameVars.warningFour) {
